...
static const Da_Const(Vendored_Source, Vendored_Sources) vendored_sources = da_const_init_from_arraylit(
    ...
    ((Vendored_Source){.name = string_from_strlit("str_number.h"), .latest_link = string_from_strlit("https://raw.githubusercontent.com/anion155/c-tools/refs/heads/main/str_number.h")}),
