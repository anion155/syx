...
Syx_Value *syx_eval_construct_native(Syx_Eval_Ctx *ctx, Syx_Type *type, Syx_Pair *arguments) {
  ...
  switch (type->kind) {
    ...
    case SYX_TYPE_KIND_VALUE_PTR: {
      *(void **)data = NULL;
      Syx_Value *argument = syx_list_next(&arguments);
      if (argument->kind == SYX_VALUE_KIND_NATIVE) {
        Syx_Type *argument_type = argument->native->type;
        switch (argument_type->kind) {
          case SYX_TYPE_KIND_PRIMITIVE: {
            switch (argument_type->primitive) {
              case SYX_PRIMITIVE_TYPE_KIND_VOID: break;
              case SYX_PRIMITIVE_TYPE_KIND_CHAR: *(void **)data = *(char *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_I8: *(void **)data = *(int8_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_I16: *(void **)data = *(int16_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_I32: *(void **)data = *(int32_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_I64: *(void **)data = *(int64_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_I128: *(void **)data = *(__int128_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_U8: *(void **)data = *(uint8_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_U16: *(void **)data = *(uint16_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_U32: *(void **)data = *(uint32_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_U64: *(void **)data = *(uint64_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_U128: *(void **)data = *(__uint128_t *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_INT: *(void **)data = *(int *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_LONG: *(void **)data = *(long *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_LLONG: *(void **)data = *(long long *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_UINT: *(void **)data = *(unsigned int *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_ULONG: *(void **)data = *(unsigned long *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_ULLONG: *(void **)data = *(unsigned long long *)argument->native->data; break;
              case SYX_PRIMITIVE_TYPE_KIND_FLOAT: break;
              case SYX_PRIMITIVE_TYPE_KIND_DOUBLE: break;
              case SYX_PRIMITIVE_TYPE_KIND_SIZE: *(void **)data = *(size_t *)argument->native->data; break;
            }
          } break;
          case SYX_TYPE_KIND_PTR:
          case SYX_TYPE_KIND_FUNCTION_PTR:
