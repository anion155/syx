    ...
    case SYX_TYPE_KIND_PRIMITIVE: {
      ...
      if (argument->kind != SYX_VALUE_KIND_PAIR || argument->pair) {
        ...
        switch (type->primitive) {
          ...
          case SYX_PRIMITIVE_TYPE_KIND_F16: *(_Float16 *)data = syx_number_get(converted->number); break;
          case SYX_PRIMITIVE_TYPE_KIND_F32: *(float *)data = syx_number_get(converted->number); break;
          case SYX_PRIMITIVE_TYPE_KIND_F64: *(double *)data = syx_number_get(converted->number); break;
          case SYX_PRIMITIVE_TYPE_KIND_F80: *(f80_canonical_t *)data = f80_canonical_from(syx_number_get(converted->number)); break;
          case SYX_PRIMITIVE_TYPE_KIND_F128: *(f128_canonical_t *)data = f128_canonical_from(syx_number_get(converted->number)); break;
          case SYX_PRIMITIVE_TYPE_KIND_F64PAIR: *(f64pair_canonical_t *)data = f64pair_canonical_from(syx_number_get(converted->number)); break;
        }
      }
    } break;
...
#define CONVERT(type) ({                                                                               \
  ...
  *(void **)data = (void *)(uintptr_t)*(type *)argument->native->data;                                 \
              ...
              switch (argument_type->primitive) {
                ...
                case SYX_PRIMITIVE_TYPE_KIND_CHAR: CONVERT(char); break;
                ...
                case SYX_PRIMITIVE_TYPE_KIND_F16: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
                case SYX_PRIMITIVE_TYPE_KIND_F32: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
                case SYX_PRIMITIVE_TYPE_KIND_F64: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
                case SYX_PRIMITIVE_TYPE_KIND_F80: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
                case SYX_PRIMITIVE_TYPE_KIND_F128: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
                case SYX_PRIMITIVE_TYPE_KIND_F64PAIR: SYX_EVAL_THROW(ctx, "invalid argument type", (), (value));
              }
#undef CONVERT
            } break;
